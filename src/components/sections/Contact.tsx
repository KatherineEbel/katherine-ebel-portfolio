...
const Contact = () => {
    return (
        <section id='contact' className='flex flex-col justify-center gap-4'>
            ...
            <p className='text-xl text-light-slate'>I am excited to start the Capstone Program at Launch School in August, and I will be quite busy for the next few months. After that I am open for opportunities.</p>
