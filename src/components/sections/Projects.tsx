...
import Wiresnoop from 'assets/wiresnoop_alt.png'
    ...
    return (
        <section id='projects' className='flex flex-col gap-12 min-w-full'>
          ...
          <Project screenshotURL={Skopos} title={'Skopos'} githubURL={'https://github.com/skopos-api-monitoring'} websiteURL={'https://skopos-api-monitoring.github.io'}>
            ...
            <p className='text-green font-medium text-center'>React, Tailwind CSS, Prisma, GraphQL, Node.js, AWS (ECS, RDS, Lambda, SNS, EventBridge), Docker</p>
            <ButtonLink href='https://skopos-api-monitoring.github.io'
            >Read the Case Study</ButtonLink>
          </Project>
          ...
          <Project screenshotURL={Wiresnoop} title={'Wiresnoop'} websiteURL={'https://wiresnoop.kathyebel.me'}>
            ...
            <h3 className='text-xl font-medium my-4'>Technologies used</h3>
            <p className='text-green text-center font-medium'>React, Socket.IO, Express, Node.js, PostgreSQL, MongoDB</p>
          </Project>
